...
export const en = {
  ...
  "error.noAudioCaptured":
    "No audio is being picked up. Check that the right input device is selected and not muted — and if the meeting is playing through your speakers, a system-audio source is needed to capture it.",
